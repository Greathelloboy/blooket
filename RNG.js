...
function click() {
	if (document.getElementById("lolinput").value == 0.67) {
		document.getElementById("lolbutton").innerHTML = "3x"
        document.getElementById("lolinput").value = 0.66
	} else {
    	document.getElementById("lolbutton").innerHTML = "Swap"
		document.getElementById("lolinput").value = 0.67
	}
}
...
function rigRngBox() {
	...
	input.value = 0.66;
	input.id = "lolinput";
	document.getElementsByClassName("styles__headerRight___1R77a-camelCase")[0].appendChild(input);

	let button = document.createElement("button");
    button.id = "lolbutton"
    button.innerHTML = "3x"
	button.onclick = function(){click()};
	document.getElementsByClassName("styles__headerRight___1R77a-camelCase")[0].appendChild(button);
